...
public class staffview extends JFrame {
	private JButton ShowTimeTable,editResults,ShowResults;
	...
	public staffview() {
		...
		this.ShowTimeTable=new JButton(" VIEW EXAM TIMETABLE");
		this.editResults=new JButton("EDIT RESULTS");
		this.ShowResults=new JButton("VIEW RESULTS");
		...
		this.ButtonPanel.add(this.editResults,BorderLayout.CENTER);
